/*************************************************
 * Nano 33 BLE Rev2
 * 2x CD4051 + 10x FSR + 1x Flex Sensor + IMU
 * 单行 CSV 输出版本
 *************************************************/
...
void loop() {
  ...
  fsr[8] = readMuxAnalog(PIN_SIG_MUX2, 0);
  fsr[9] = readMuxAnalog(PIN_SIG_MUX2, 1);

  // ---------- 读取弯曲传感器（MUX2 CH5） ----------
  flex = readMuxAnalog(PIN_SIG_MUX2, 5);
